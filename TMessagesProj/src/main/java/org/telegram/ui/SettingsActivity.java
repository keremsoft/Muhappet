    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                } else if(i== telegramFaqRow || i == askQuestionRow || i == languageRow){
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "Muhappet v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == overscrollRow || i == telegramFaqRow || i == askQuestionRow || i == languageRow) {
                return 0;
                ...
                return 3;
            } else if (i == notificationRow || i == backgroundRow || i == sendLogsRow || i == privacyRow || i == clearLogsRow || i == switchBackendButtonRow || i == contactsReimportRow || i == textSizeRow || i == contactsSortRow) {
                return 2;
